    ...
    $('#categoriesTable').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    $.ajax({
                        type: 'GET',  // kategori listesi almak icin, get islemini hangi urle yapicam
                        ...
                        // ajax işlemini yaptik ve basarili bir sekilde return dondu -> categoryListDto json formatında geldi
    ...
    $(function () {
        ...
        placeHolderDiv.on('click',
            ...
            function (event) {
                ...
                const actionUrl = form.attr('action'); /* action urlini okuyoruz - formdaki, bu form tam olarak hangi urle post edilmeli */
                const dataToSend = form.serialize(); /* gönderilecek veriyi formu serilestirerek aldik */

                /* aslinda form icindeki veriyi bi tane categoryAddDto olarak donusturmus olduk
                 * formdan gerekli verileri aldıgımıza gore bunları gerekli urle post edebiliriz
                ...
                $.post(actionUrl, dataToSend).done(function (data) {
                    ...
                    /*  yeni geken partialviewi form model içersine asmalıyız, yani oradaki veriyle buradakini degistimek
                        ...
                        - modelimiz icerisindeki partialview icinden seciyoruz
                    */

                    const newFormBody = $('.modal-body', categoryAddAjaxModel.CategoryAddPartial);

                    /* eskisiyle yer degistirelim,
                        modelbody'i bulduk -> modelbody htmlini yeni partialview deki html ile degistirmek istiyoduk */

                    placeHolderDiv.find('.modal-body').replaceWith(newFormBody);

                    /* formumuz icindeki isvalid durumunu yani orada ekledigimiz bilgileri oradan almak istiyoruz
                        - newformody üzerindeki ekledigimiz input kısmını seciyoruz */
                    ...
                    if (isValid) {
                        ...
                        /* table row olusturduk ama string jquery objesi haline getircez ki jquery kodlarını kullanabilelim */
                        ...
                        /* validation - summary'yi secmeliyiz, hatali islem yaptigimizda(invalid) orada bir div aciliyor
                            div icersinde ul oluyor ve ul icinde li oluyo, li'ler icinde donmeliyiz*/
