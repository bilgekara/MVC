...
namespace ProgrammersBlog.Data.Concrete.EntityFramework.Mappings
{
    public class ArticleMap : IEntityTypeConfiguration<Article>
    {
        ...
        {
            builder.HasKey(a => a.Id); // bunun bir primary key alanı var mı?
            builder.Property(a => a.Id).ValueGeneratedOnAdd(); //identity ->eklendikce deger olustur
            builder.Property(a => a.Title).HasMaxLength(100); //title alanı en fazla 100 karakter olsun
            ...
            builder.ToTable("Articles"); // tablo olarak ismi
        }
    }
}
